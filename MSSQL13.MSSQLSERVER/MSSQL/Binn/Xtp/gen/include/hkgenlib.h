...
HKGAPI __forceinline HKNOALIAS_USEWITHCAUTION __checkReturn unsigned short
LenCharDBCS_CP932(
	__in_ecount(length) const unsigned char* value, unsigned short length);
...
HKGAPI __forceinline HKNOALIAS_USEWITHCAUTION __checkReturn unsigned short
LenWChar(__in_ecount(length) const unsigned char* value, unsigned short length);

HKGAPI __forceinline HKNOALIAS_USEWITHCAUTION __checkReturn unsigned short
LenWCharUTF16(__in_ecount(length) const unsigned char* value, unsigned short length);

HKGAPI __forceinline HKNOALIAS_USEWITHCAUTION __checkReturn void
...
HKGAPI __forceinline HKNOALIAS_USEWITHCAUTION __checkReturn unsigned short
GetDBCSTruncLen_CP932(unsigned char* value, unsigned short srclen);

HKGAPI __forceinline HKNOALIAS_USEWITHCAUTION __checkReturn unsigned short
GetDBCSTruncLen_CPOther(unsigned char* value, unsigned short srclen);

HKGAPI __forceinline HKNOALIAS_USEWITHCAUTION __checkReturn bool
ShouldRemoveTrailingHighSurrogate(
	unsigned short oldByteLength,
	__in_ecount(oldByteLength) unsigned char* value,
	unsigned short newByteLength);
...
HKGAPI __checkReturn HRESULT
SendLockBytes(__in struct HkProcContext* hkcontext, struct HkILBHandle* value, long textSize, __in_opt bool (*isDBCSLeadChar) (const unsigned char));

HKGAPI __checkReturn HRESULT
SendNullableLockBytes(__in struct HkProcContext* hkcontext, struct HkILBHandle* value, long textSize, __in_opt bool (*isDBCSLeadChar) (const unsigned char), unsigned char isNull);
